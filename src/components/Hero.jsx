...
const Hero = () => {
    return (
        <div id="hero-section" className=' bg-orange-50 h-[600px] '>
            <div className='flex lg:flex-row flex-col items-center justify-center p-5 lg:max-w-7xl mx-auto relative'>
                <div className='lg:w-1/2 lg:space-y-6 lg:px-10 relative z-20' >
                    ...
                    <h1 className='font-bold text-4xl lg:text-6xl tracking-normal mt-4 lg:mt-0'><span className='text-red-500'>Delicious</span>  Meals Delivered to Your Doorsteps.</h1>
                    ...
                    <div className='flex gap-3'>
                        <a href="#menu" className='bg-red-500 px-3 py-2 z-20 rounded-lg text-white hover:bg-red-600 hover:scale-110 transition-all'>
                            Order Now
                        </a>
                        <a href="#contact" className='bg-red-500 px-3 py-2 z-20 rounded-lg text-white hover:bg-red-600 hover:scale-110 transition-all'>
                            Contact Now
                        </a>
                    </div>
                </div>
